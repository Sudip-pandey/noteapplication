...
// <![CDATA[
CommonParams.setAll({common_query:"lang=en",opendb_url:"index.php?route=/database/structure&lang=en",lang:"en",server:"1",table:"",db:"",token:"644e302360277e437d3a5a6f515f5b5e",text_dir:"ltr",LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.0",auth_type:"config",user:"root"});
...
<body>
    <div id="pma_navigation" class="d-print-none" data-config-navigation-width="300">
  ...
  <a href="index.php?route=/table/recent-favorite&db=note&table=note&lang=en">
    `note`.`note`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=note&table=users&lang=en">
    `note`.`users`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=note&table=tags&lang=en">
    `note`.`tags`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=shopping_db&table=sub_categories&lang=en">
    `shopping_db`.`sub_categories`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=shopping_db&table=categories&lang=en">
    `shopping_db`.`categories`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.bm90ZQ==" data-vpath="cm9vdA==.bm90ZQ==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=note&lang=en"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=note&lang=en" title="Structure">note</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.c2hvcHBpbmdfZGI=" data-vpath="cm9vdA==.c2hvcHBpbmdfZGI=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=shopping_db&lang=en"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=shopping_db&lang=en" title="Structure">shopping_db</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="644e302360277e437d3a5a6f515f5b5e">
...
<tr>
  ...
  <td>
          <input type="number" name="NavigationWidth" id="NavigationWidth" value="300" class="custom">
